...
int main (){
	printf("Programa 80: Desarrolle el procedimiento el cual sume los elementos que se encuentran por arriba de la diagonal princ.\n"); 
	...
	printf("\n\n\tLa suma de los elementos arriba de la diagonal principal de la matriz da:%d",suma);
	return 0;
}

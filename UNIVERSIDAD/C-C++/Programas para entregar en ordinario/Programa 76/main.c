...
int main (){
	printf("Programa 76: Desarrolle el procedimiento el cual sume los elementos de cada fila de una matriz cuadrada y posteriormente\n"); 
	...
	printf("\tLa suma de la fila es: %d", suma);
	}
	return 0;
}

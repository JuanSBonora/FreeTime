...
int main (){
	printf("Programa 85: Desarrolle el procedimiento el cual efectue el producto de dos matrices de las mismas dimensiones\n"); 
	...
	system("cls");
	impmat ();
	printf("\n\n\tEl producto de estas dos matrices genera: \n");
	multmat();
	return 0;
}

...
int fila, filamat2, colmat2 = 0, col = 0, i, j;
int mat[50][50];
int mat2[50][50];
int mat3[50][50];
...
int main (){
	printf("Programa 83: Desarrolle el procedimiento el cual efectue la suma de dos matrices de las mismas dimensiones.\n"); 
	...
	system("cls");
	impmat ();
	printf("\n\n\tLa suma de estas dos matrices genera: \n");
	summat();
	return 0;
}
